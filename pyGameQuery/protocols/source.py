...
class sourceQueryPlayers(sourceQueryBase):
    def sendRequest(self):
        self.send(b"\xFF\xFF\xFF\xFF\x55\xFF\xFF\XFF\XFF")
    
    #We need to bypass this for player info
    preprocessData = sourceQueryBase.processData
    def processData(self, data):
        if data[0] == 0x55:
